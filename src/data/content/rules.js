export const rules = {
  ...
  "roleplay-rules": {
    ...
    blocks: [
      ...
      { type: "p", text: "You must play your **approved character** at all times while on the server. You as a player can only change character if you have a character death in gameplay." },
  ...
  "stealing-rules": {
    ...
    blocks: [
      ...
      { type: "p", text: "You may steal from another player's containers only during Campaigns" },
